import { minimumNodeSizes, validateNode } from "../../../../shared/canvas-schema";
import type { ChartNodeType, ShapeNodeType, DecorationNodeType, PanelFrameNodeType, Model3DNodeType, DashboardNodeType, BasicNodeType, CanvasNodeType, CanvasThemeMode, CanvasThemePresetId, CanvasBackgroundPattern, CanvasFontFamily, CanvasTheme, ChartProps, ShapeProps, TextAlign, DecorationProps, PanelFrameStyle, PanelFrameProps, DashboardTone, DashboardBaseProps, MetricCardProps, RadialGaugeProps, ProgressListItem, ProgressListProps, StatusGridItem, StatusGridProps, RankingTrend, RankingListItem, RankingListProps, AlarmListItem, AlarmListProps, DataTableProps, TimelineItem, EventTimelineProps, DashboardProps, BasicOption, BasicAppearanceProps, PlainTextProps, TextLinkProps, ImageProps, CarouselProps, ButtonProps, SwitchProps, CheckboxGroupProps, RadioGroupProps, SelectProps, BasicProps, Vector3Tuple, ModelNodeTransform, ModelNodeAppearance, ModelCameraView, Model3DProps, CanvasNode, CanvasDocument } from "../../../../shared/canvas-schema";
export type { ChartNodeType, ShapeNodeType, DecorationNodeType, PanelFrameNodeType, Model3DNodeType, DashboardNodeType, BasicNodeType, CanvasNodeType, CanvasThemeMode, CanvasThemePresetId, CanvasBackgroundPattern, CanvasFontFamily, CanvasTheme, ChartProps, ShapeProps, TextAlign, DecorationProps, PanelFrameStyle, PanelFrameProps, DashboardTone, DashboardBaseProps, MetricCardProps, RadialGaugeProps, ProgressListItem, ProgressListProps, StatusGridItem, StatusGridProps, RankingTrend, RankingListItem, RankingListProps, AlarmListItem, AlarmListProps, DataTableProps, TimelineItem, EventTimelineProps, DashboardProps, BasicOption, BasicAppearanceProps, PlainTextProps, TextLinkProps, ImageProps, CarouselProps, ButtonProps, SwitchProps, CheckboxGroupProps, RadioGroupProps, SelectProps, BasicProps, Vector3Tuple, ModelNodeTransform, ModelNodeAppearance, ModelCameraView, Model3DProps, CanvasNode, CanvasDocument } from "../../../../shared/canvas-schema";
...
export { minimumNodeSizes } from "../../../../shared/canvas-schema";
...
/** Props editing uses the same boundary as project loading and API persistence. */
export const parseModel3DProps = (props: Record<string, unknown>): Model3DPropsResult => {
  try {
    const node = validateNode({ id: "model-props-validation", type: "model-3d", x: 0, y: 0, width: 360, height: 240, zIndex: 0, props, resourceRefs: [], dataBindingRefs: [] });
    return { ok: true, value: node.props as Model3DProps };
  } catch (reason) { return { ok: false, message: reason instanceof Error ? reason.message : String(reason) }; }
};
