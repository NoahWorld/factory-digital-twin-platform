...
class PublicSharesTest {
  ...
  final PublicShares publications = spy(new PublicShares(projects, mock(Documents.class), resources,
  ...
  @Test void signedLinkOnlyReadsScopedProjectsAndStopsAfterRevocation() {
    String id = Json.id();
    var publication = new PublicShares.Publication(id, "tenant", "root");
  ...
  @Test void publishedResourceEndpointsExposeOnlyReferencedFiles() {
    ...
    var controller = new PublicShareController(publications);
