...
public class PublicShares {
  ...
  PublicShares(Projects projects, Documents documents, Resources resources,
...
class PublicShareController {
  final PublicShares publication;

  PublicShareController(PublicShares publication) {
