-- Let a 2D canvas reference a standalone 3D project and render the currently
-- selected business asset. The 3D scene remains normalized in standalone scene
-- tables; the canvas stores only the project reference and presentation props.
