-- Add lightweight animated technology and industrial decoration nodes.
-- Animation stays in the web renderer; persisted nodes contain only the
-- approved node type and the existing validated decoration color properties.
