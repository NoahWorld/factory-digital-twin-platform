-- Add controlled project image resources. Binary bytes stay in object storage;
-- canvas nodes only retain image asset IDs in resource_refs_json.
...
CREATE INDEX image_assets_project_created_idx
  ON image_assets(project_id, created_at DESC, id);

-- Expand the explicit canvas whitelist with content and interaction components.
