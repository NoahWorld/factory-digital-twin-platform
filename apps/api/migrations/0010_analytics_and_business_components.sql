-- Expand the canvas whitelist with analytical charts and operational business views.
-- Component configuration remains in props_json; large files and live data stay outside the canvas document.
